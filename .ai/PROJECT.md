...
- Your production code architecture
- Your host-specific runtime policy
- Your project-specific smoke, deploy, or rollback commands

## Adoption guidance

When this template is cloned for a real project, replace the identity section with project-specific context and keep the workflow contract intact unless you intentionally want to change the methodology.

...
- Hand off to `deliver-change`, `implement-feature`, or `fix-bug` with the sprint index and subplans as the execution brief.
- Hand off back to `author-specs` if planning reveals missing product, data, or API specs.
